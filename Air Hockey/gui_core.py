...
class GUICore:
    ...
    def update(self, paddle1_pos, paddle2_pos, puck_pos, goals):
        ...
        pygame.draw.circle(self.screen, (0, 0, 255), (paddle1_pos['x'], paddle1_pos['y']), 20)
        pygame.draw.circle(self.screen, (255, 0, 0), (paddle2_pos['x'], paddle2_pos['y']), 20)
        ...
        self.screen.blit(score_text, (self.board_width // 2 - score_text.get_width() // 2, self.board_height - 30))
        ...
        self.screen.blit(player2_name, (self.board_width - player2_name.get_width() - 50, self.board_height - 30))
